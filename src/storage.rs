...
impl FromStr for StorageUnit {
    ...
    fn from_str(unit: &str) -> Result<Self, Self::Err> {
        match unit.to_lowercase().as_str() {
            "b" | "byte" => Ok(StorageUnit::B), "kb" | "kilobyte" => Ok(StorageUnit::Kb), "mb" | "megabyte" => Ok(StorageUnit::Mb), "gb" | "gigabyte" => Ok(StorageUnit::Gb),
...
impl LinearUnit for StorageUnit {
    ...
    fn valid_str_units() -> &'static [&'static str] { &["b", "byte", "kb", "kilobyte", "mb", "megabyte", "gb", "gigabyte"] }
}